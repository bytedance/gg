...
func (s *{{.StructPrefix}}Map{{.StructSuffix}}{{.TypeArgument}}) ToMap() map[{{.KeyType}}]{{.ValueType}} {
	m := make(map[{{.KeyType}}]{{.ValueType}}, s.Len())
	s.Range(func(key {{.KeyType}}, value {{.ValueType}}) bool {
		m[key] = value
		return true
	})
	return m
