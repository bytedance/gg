...
func newOrderedNode[T constraints.Ordered](value T, level int) *orderednode[T] {
	n := &orderednode[T]{
		value: value,
		level: uint32(level),
	}
...
func unlockordered[T constraints.Ordered](preds [maxLevel]*orderednode[T], highestLevel int) {
