...
// JSONCodec is an extended interface for codecs that support indentation and validation.
// It combines Codec, Validator, and PrettyMarshaler.
...
// Common implementations include jsoniter.ConfigDefault, and sonic.ConfigDefault.
