...
// Stream is a wrapper of [github.com/bytedance/gg/iter.Iter] with method
// chaining support.
//
...
// See function [github.com/bytedance/gg/iter.Map].
...
// See function [github.com/bytedance/gg/iter.Fold].
...
// See function [github.com/bytedance/gg/iter.Reduce].
...
// See function [github.com/bytedance/gg/iter.ForEach].
func (s Stream[T]) ForEach(f func(T)) {
	iter.ForEach(f, s.Iter)
}

// See function [github.com/bytedance/gg/iter.ForEachIndexed].
func (s Stream[T]) ForEachIndexed(f func(int, T)) {
	iter.ForEachIndexed(f, s.Iter)
}

// See function [github.com/bytedance/gg/iter.Head].
...
// See function [github.com/bytedance/gg/iter.All].
func (s Stream[T]) All(f func(T) bool) bool {
	return iter.All(f, s.Iter)
}

// See function [github.com/bytedance/gg/iter.Any].
...
// See function [github.com/bytedance/gg/iter.At].
...
// See function [github.com/bytedance/gg/iter.Chunk].
//
...
// See function [github.com/bytedance/gg/iter.GroupBy].
...
// See function [github.com/bytedance/gg/iter.Divide].
//
// FIXME: Returning a Stream[[]T] causes instantiation cycle of type parameters.
